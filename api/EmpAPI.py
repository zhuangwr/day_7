...
class EmpCRUD:
    ...
    # 请求函数：增
    def add(self, session, username=None, mobile=None, timeOfEntry=None, formOfEmployment=None,
        ...
        return session.post(self.emp_url, json=my_add,
